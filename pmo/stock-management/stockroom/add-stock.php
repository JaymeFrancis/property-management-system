    ...
    <?php include '../../../navbar.php'; ?>  
        ...
        <div class="info">
                    ...
                    <div class="col-6 md-6 order-md-1 order-first">
                        ...
                        ?>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="stkrm-stocks.php?ref=<?=$refid?>" style="text-decoration: none;">Stocks</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add Stock</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-6 md-6 order-md-2 order-last">  
                        <a class="btn btn-close float-end" href="stkrm-stocks.php?ref=<?=$refid?>" role="button" style="border-radius: 0;"></a>
                    </div>
                </div>
            </div>
                <?php
            ...
            <div class="container">
                ...
                if(isset($_GET['ref'])){
                    $refid = $_GET['ref'];
                    $query = "SELECT * FROM tbl_particulars_stockroom WHERE id = '$refid'";
                    $result = mysqli_query($conn, $query);
                    $row = mysqli_fetch_assoc($result);
                ?>
            <form class="needs-validation" action="fn-stkrm.php" method="post" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php
                            ...
                            $countItemCode = "SELECT COUNT(item_code) FROM tbl_stock_stockroom WHERE item_code LIKE '%$itemcode%'";
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="validationCustom06" placeholder="₱ 0.00" name="price" step=".01" data-type="currency" required>
