        ...
        <div class="info">
            ...
            <div class="table-responsive">
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    if (isset($_GET['ref'])):
                    $refid = $_GET['ref'];
                    $query = "SELECT *, quantity*price AS amount, issuance_qty*price AS issuance_amt, rem_qty*price AS rem_amt FROM tbl_stock_stockroom WHERE id = '$refid' AND rem_qty > 0 ";
                    $result = mysqli_query($conn, $query);
