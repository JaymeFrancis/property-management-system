...
<?php include '../../pmo-nav.php'; ?>
    ...
    <?php include '../../../navbar.php'; ?>  
        ...
        <div class="info">
            ...
            <div class="page-title">
                <div class="row" style="display: flex;">
                    <div class="col-6 md-6 order-md-1 order-first">
                        <h2>Update Stockroom Particular</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Update Stockroom Particular</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-6 md-6 order-md-2 order-last">  
                        <a class="btn btn-close float-end" href="stkrm-particulars.php" role="button" style="border-radius: 0;"></a>
                    </div>
                </div>
            </div>
            ...
            <form class="needs-validation" action="fn-stkrm.php" method="post" novalidate>
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        if(isset($_GET['ref'])){
                            $refid = $_GET['ref'];
                            $query = "SELECT particulars FROM tbl_particulars_stockroom WHERE id = '$refid'";
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        if(isset($_GET['ref'])){
                            $refid = $_GET['ref'];
                            $query = "SELECT item_code FROM tbl_particulars_stockroom WHERE id = '$refid'";
                            $result = mysqli_query($conn, $query);
                            $row = mysqli_fetch_assoc($result);
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary bg-opacity-10" onfocus="this.blur()" name="stock_type" value="Stockroom" readonly="readonly">
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        if(isset($_GET['ref'])){
                            $refid = $_GET['ref'];
                            $query = "SELECT unit FROM tbl_particulars_stockroom WHERE id = '$refid'";
                            $result = mysqli_query($conn, $query);
                            $row = mysqli_fetch_assoc($result);
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        if(isset($_GET['ref'])){
                            $refid = $_GET['ref'];
                            $query = "SELECT order_level FROM tbl_particulars_stockroom WHERE id = '$refid'";
                            $result = mysqli_query($conn, $query);
                            $row = mysqli_fetch_assoc($result);
            ...
            <button class="btn btn-primary float-end" type="submit" style="border-radius: 0;" name="editParticular">Submit</button>
            </form>
            </div>
