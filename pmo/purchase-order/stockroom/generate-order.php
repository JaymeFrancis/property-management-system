                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-1">
                                            ...
                                            <a href="fn-stkrm.php?remove=<?= $orders['id'] ?>" class="btn btn-danger remove-item"><i class="fa fa-remove"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
                            ...
                            <a href="fn-stkrm.php?generateOrder=generateOrder" type="button" class="btn btn-primary float-end" id="generateOrder" name="generateOrder">Generate</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="addItem" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="fn-stkrm.php" method="POST" novalidate>
        ...
        $date = date('F');
            $query = "SELECT particulars 
                     ...
                     WHERE NOT EXISTS (SELECT particulars FROM tbl_purchaseitems_stockroom 
                     WHERE tbl_particulars_stockroom.particulars = tbl_purchaseitems_stockroom.particulars 
                     AND tbl_purchaseitems_stockroom.month = '$date')
                     AND NOT EXISTS (SELECT particulars FROM sample_order
                     WHERE tbl_particulars_stockroom.particulars = sample_order.particulars)";
            $result = mysqli_query($conn, $query);
        ?>
...
xhttp.open("GET", "fn-stkrm.php?p="+str);
xhttp.send();
}
