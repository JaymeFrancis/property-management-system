            ...
            <form class="needs-validation" action="fn-stkrm.php" method="post" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="datepicker" value="<?php echo date('m/d/Y'); ?>" name="req_date">
                        <div class="invalid-feedback">Please Choose a Date</div>
                    </div>
                </div>
            <button class="btn btn-primary float-end" type="submit" style="border-radius: 0;" name="newIssuance">Submit</button>
            </form>
            </div>
