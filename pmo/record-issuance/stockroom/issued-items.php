                        ...
                        <div class="card-body ">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped table-bordered">
                                    ...
                                    if(isset($_GET['ref'])):
                                        $refid = $_GET['ref'];
                                        $query = "SELECT * FROM tbl_ris_stockroom WHERE iss_no = '$refid'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $items['unit']; ?></td>
                                            <td>
                                                <a href="fn-stkrm.php?remove=<?= $items['id']; ?>" type="button" name="removeItem" class="btn btn-danger btn-sm px-3 remove-item">Remove</a>
                                            </td>
                                        </tr>
                                        <?php
                                            }
                                ...
                                <a href="fn-stkrm.php?releaseID=<?=$refid?>" type="button" name="releaseIssuance" class="btn btn-primary float-end release-issuance">Release</a>
                                <?php
                                endif;
                                ?>
                            </div>
