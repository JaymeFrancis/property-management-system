...
<?php include '../../pmo-nav.php'; ?>
    ...
    <?php include '../../../navbar.php'; ?>  
        ...
        ?>
            ...
            ?>
            <div class="container">
            <form class="needs-validation" action="fn-stkrm.php" method="post" onsubmit="return submitForm(this);" novalidate>
                <?php
                if(isset($_GET['ref'])):
                    $refid = $_GET['ref'];
                ...
                <div class="row" >
                    <div class="col-md-6 mb-3">
                        ...
                        <?php
                        $query = "SELECT particulars FROM tbl_particulars_stockroom";
...
function showItemCode(str) {
  ...
  xhttp.open("GET", "fn-stkrm.php?q="+str);
  xhttp.send();
}
</script>
