        ...
        <div class="info">
            <div class="page-title">
                <div class="row" style="display: flex;">
                    <div class="col-6 md-6 order-md-1 order-first">
                        <h2>Stockroom Stock Position Report</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item text-primary">Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Stockroom Stock Position Report</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="table-responsive text-nowrap">
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                    <?php 
                        $query = "SELECT * FROM stockroom_report";
