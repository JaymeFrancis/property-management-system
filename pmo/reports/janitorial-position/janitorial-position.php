        ...
        <div class="info">
            <div class="page-title">
                <div class="row" style="display: flex;">
                    <div class="col-6 md-6 order-md-1 order-first">
                        <h2>Janitorial Stock Position Report</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item text-primary">Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Janitorial Stock Position Report</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-6 md-6 order-md-2 order-last">
                            <button type="submit" name="generateSIR" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#generateSIR">Generate Stock<br> Position Report</button>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive text-nowrap">
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                    <?php 
                        $query = "SELECT * FROM janitorial_report";
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $purchase['year']; ?></td>
                            <td>
                                <a href="printSPRSS.php?ref=<?= $purchase['id']; ?>" target="_blank" type="button" name="printOrder" class="btn btn-info"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                    <?php
                        }
