        ...
        <div class="info">
            <div class="page-title">
                <div class="row" style="display: flex;">
                    <div class="col-6 md-6 order-md-1 order-first">
                        <h2>Stockroom Issuance Report</h2>
                    ...
                    <div class="col-6 md-6 order-md-2 order-last">
                            <button type="submit" name="generateSIR" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#generateSIR">Generate <br> Issuance Report</button>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive text-nowrap">
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                    <?php 
                        $query = "SELECT * FROM stockroom_issuance_report";
    ...
    <div class="modal-content">
      <form action="fn-report.php" method="POST" novalidate>
        ...
        <div class="modal-footer">
            <button type="submit" name="generateSIR" class="btn btn-primary">Submit</button>
