            ...
            <div class="page-title">
                <div class="row" style="display: flex;">
                    ...
                    <div class="col-6 md-6 order-md-2 order-last">
                            <button type="submit" name="generateSIR" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#generateSIR">Generate<br> Summary Report</button>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $purchase['year']; ?></td>
                            <td>
                                <a href="printSR.php?ref=<?= $purchase['id']; ?>" target="_blank" type="button" name="printOrder" class="btn btn-info"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                    <?php
                        }
