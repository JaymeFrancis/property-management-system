...
$pdf ->Cell(55, 5, '', 0,0);
$pdf ->Cell(80, 5, 'MONTHLY STOCK POSITION REPORT OF JANITORIAL SUPPLIES', 0, 0, 'C');
$pdf ->Cell(55, 5, '', 0,1);
...
if(isset($_GET['ref'])){
    ...
    $query = "SELECT *, quantity*price AS amount, issuance_qty*price AS issuance_amt, rem_qty*price AS rem_amt FROM tbl_stock_janitorial WHERE item_code != '' ORDER BY particulars";
